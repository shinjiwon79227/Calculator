...
fun main() {
    ...
    while (flag) {
        ...
        when(inputBtn){ // 버튼이
            1 -> result = Calculator3().calculate(AddOperation(numArr.get(0), numArr.get(1)))
            2 -> result = Calculator3().calculate(SubstractOperation(numArr.get(0), numArr.get(1)))
            3 -> result = Calculator3().calculate(MultiplyOperation(numArr.get(0), numArr.get(1)))
            4 -> result = Calculator3().calculate(DivideOperation(numArr.get(0), numArr.get(1)))
